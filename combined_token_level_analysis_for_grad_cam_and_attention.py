...
print("📂 Loading pre-split data from train_test_2 folder...")
...
def perform_combined_statistical_analysis(token_df, image_df, output_dir):
    ...
    for method in ["gradcam", "attention"]:
        ...
        print(f"  Spearman: ρ = {rho:7.4f}, p = {p_spear:.4e}")
    ...
    if r_grad**2 > r_attn**2:
        print(f"\n✅ Grad-CAM is MORE predictive (Δ = {(r_grad**2 - r_attn**2):.4f})")
    else:
        print(f"\n✅ Attention is MORE predictive (Δ = {(r_attn**2 - r_grad**2):.4f})")
